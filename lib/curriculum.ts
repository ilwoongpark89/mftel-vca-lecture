...
export const CURRICULUM: WeekDef[] = [
  { week: 1, title: "LLM 작동 원리", chapters: ["1-1", "1-2", "1-3", "1-4", "1-5", "1-6"] },
  { week: 2, title: "근거 기반 프롬프트 기법", chapters: ["2-1", "2-2", "2-3", "2-4", "2-5", "2-6"] },
  { week: 3, title: "컨텍스트 엔지니어링·에이전트", chapters: ["3-1", "3-2", "3-3", "3-4", "3-5", "3-6"] },
  { week: 4, title: "평가·실패모드·재현성", chapters: ["4-1", "4-2", "4-3", "4-4", "4-5", "4-6"] },
];
